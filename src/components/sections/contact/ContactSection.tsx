...
function ContactSection() {
  ...
  return (
    <form id="footer" className="mx-auto w-full max-w-75 sm:max-w-75">
      <div className="mb-8">
        <h2 className="mb-2 text-center text-4xl font-bold text-[#c2c6da]">Contact</h2>
        <div className="mx-auto h-1 w-24 rounded-full bg-linear-to-r from-orange-400 to-yellow-400"></div>
      </div>
      <label htmlFor="clipboard" className="sr-only mb-2 text-sm font-medium text-white">
        Search
      </label>
