...
export default function AboutMeSection() {
  ...
  return (
    <div className="relative max-w-[300px] mx-auto mt-10 flex items-center sm:max-w-[575px] md:mt-0 md:h-full md:max-h-fit md:max-w-[450px] md:text-sm lg:mt-0 lg:max-h-full lg:max-w-lg lg:text-base xl:mt-0">
