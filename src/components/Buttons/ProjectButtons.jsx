...
const ProjectButtons = ({ demo, code }) => {
  return (
    <div className="flex flex-wrap gap-4">
      <a
        target="_blank"
        className="group flex items-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-yellow-500 px-6 py-3 font-medium text-white transition-all duration-300 hover:from-orange-600 hover:to-yellow-600 hover:shadow-lg hover:shadow-orange-500/25"
        href={demo}
      >
        <EyeIcon />
        View Live Project
